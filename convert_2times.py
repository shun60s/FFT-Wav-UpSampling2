...
class convert2times(object):
    def __init__(self,path_input_wav, path_output_wav=None , output_bit=16, method="COWM"):
        # initalize
...
if __name__ == '__main__':
    ...
    if args.dir is not None  and os.path.exists(args.dir):
        ...
        for i,file_path in enumerate(flist):
            # create instance
            conv1= convert2times(file_path, output_bit=args.output_bit, method=args.method)
            # destruct instance
            del conv1
    else: # do once
    # create instance
        conv1= convert2times(args.input_wav, args.output_wav, output_bit=args.output_bit, method=args.method)
